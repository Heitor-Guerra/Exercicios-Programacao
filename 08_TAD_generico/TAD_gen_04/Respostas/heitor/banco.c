 ...
 * @return Um ponteiro para o novo banco criado. Se a memória não puder ser
 ...
 */
void LeBanco(tBanco *banco) { scanf("%[^\n]\n", banco->nome); }
...
/**
 * @brief Função para imprimir o relatório de um banco, com o nome do banco e a
 * lista de agências.
 * @param banco O banco.
 */
