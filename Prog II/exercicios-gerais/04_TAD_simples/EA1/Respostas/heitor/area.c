 ...
 */
int comparaArea(Area a1, Area a2) { return strcmp(a1.id, a2.id) == 0; }

/*
 * Função que verifica se o id passado é igual ao id da área passada
 * Retorna 1 se for igual e 0 caso contrário
 */
int verificaIdArea(Area a, char *id) { return strcmp(a.id, id) == 0; }

/**
 * Função que retorna a capacidade de uma área comum.
 */
int getCapacidadeArea(Area a) { return a.capacidade; }
