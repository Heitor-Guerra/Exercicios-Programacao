 ...
 * @return tVendedor Retorna a estrutura do tipo tVendedor com os dados do
 * vendedor registrado.
 */
tVendedor RegistraVendedor(char nome[50], float salario, float prct_comissao) {
  tVendedor vend = {"", 0, salario, prct_comissao};
 ...
 * @return int Retorna 1 se o nome do vendedor é igual ao nome passado como
 * parâmetro, ou 0 caso contrário.
 */
 ...
 * @return tVendedor Retorna a estrutura do tipo tVendedor atualizada com o
 * valor da venda contabilizada.
 */
 ...
 */
float GetSalario(tVendedor vendedor) { return vendedor.salario; }
 ...
 */
float GetTotalVendido(tVendedor vendedor) { return vendedor.valor_vendido; }
