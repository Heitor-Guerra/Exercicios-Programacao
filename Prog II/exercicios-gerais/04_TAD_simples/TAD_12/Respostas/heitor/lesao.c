...
*/
Lesao lerLesao() {
  char cartao[MAX_CARTAO_LES], id[MAX_ID_LES], diagnostico[MAX_DIAG_LES],
      regiao[MAX_REG_LES];
  int malignidade;
  ...
  Lesao lesao = criaLesao(cartao, id, diagnostico, regiao, malignidade);
  return lesao;
}
...
*/
int verificaCirurgicaLesao(Lesao l) { return l.malignidade > 50; }
