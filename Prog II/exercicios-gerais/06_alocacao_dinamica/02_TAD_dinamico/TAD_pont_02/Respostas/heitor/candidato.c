...
/**
 * @brief Apaga toda a memória alocada dinamicamente para guardar as informações
 * de um candidato
...
void LeCandidato(tCandidato *candidato) {
  candidato->nome = (char *)malloc(20 * sizeof(char));
 ...
 */
char ObtemCargo(tCandidato *candidato) { return candidato->cargo; }

/**
 * @brief Incrementa 1 voto ao candidato.
 * @param candidato Candidato a ter os votos incrementados.
 */
void IncrementaVotoCandidato(tCandidato *candidato) { candidato->votos++; }
 ...
 */
int ObtemVotos(tCandidato *candidato) { return candidato->votos; }
