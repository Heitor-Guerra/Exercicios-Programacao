...
/**
 * @brief Apaga/Libera toda a memória alocada dinamicamente para armazenar dados
 * de um eleitor
 * @param eleitor Ponteiro para eleitor que será apagado.
 */
void ApagaEleitor(tEleitor *eleitor) { free(eleitor); }
 ...
 */
int ObtemVotoPresidente(tEleitor *eleitor) { return eleitor->votoP; }
 ...
 */
int ObtemVotoGovernador(tEleitor *eleitor) { return eleitor->votoG; }
