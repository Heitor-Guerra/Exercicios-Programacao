 ...
 * @param rows Número de linhas da matriz.
 * @param cols Número de colunas da matriz.
 * @param matrix Matriz a ser impressa. Após a impressão da matriz, deve ser
...
/**
 * @brief Soma duas matrizes e armazena o resultado em result. Não é feito teste
 * de possibilidade de soma.
 * @param rows1 Número de linhas da primeira matriz.
 * @param cols1 Número de colunas da primeira matriz.
...
void matrix_add(int rows1, int cols1, int matrix1[rows1][cols1], int rows2,
                int cols2, int matrix2[rows2][cols2],
...
/**
 * @brief Subtrai duas matrizes e armazena o resultado em result. Não é feito
 * teste de verificação de subtração.
 * @param rows1 Número de linhas da primeira matriz.
 * @param cols1 Número de colunas da primeira matriz.
 * @param matrix1 Primeira matriz.
 * @param rows2 Número de linhas da segunda matriz.
...
/**
 * @brief Multiplica duas matrizes e armazena o resultado em result. Não é feito
 * teste de verificação para a multiplicação. A matriz result deve ser
 * inicializada com 0 dentro desta função.
 * @param rows1 Número de linhas da primeira matriz.
 * @param cols1 Número de colunas da primeira matriz.
 * @param matrix1 Primeira matriz.
 * @param rows2 Número de linhas da segunda matriz.
...
/**
 * @brief Transpõe a matriz especificada. O resultado da transposta deve ser
...
/**
 * @brief Multiplica a matriz especificada por um escalar, mantendo o resultado
 * na própria matriz.
 * @param rows Número de linhas da matriz.
 * @param cols Número de colunas da matriz.
